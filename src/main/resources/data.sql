...
CREATE TABLE abernathyclinic_mediscreen.users
(
    uuid uuid NOT NULL,
...
-- -------| Below are data used for testing purpose |-------

BEGIN;
INSERT INTO abernathyclinic_mediscreen.users(
	uuid, last_name, first_name, date_of_birth, sex, home_address, phone_number)
